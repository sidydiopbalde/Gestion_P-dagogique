...
<nav class="bg-gray-800 p-4">
    <div class="container mx-auto">
        <div class="flex items-center justify-between">
            ...
            <?php if ($cours) : ?>
            <a href="#" class="text-white text-lg font-medium">Prof: <?= $cours[0]->getNom() ?? ""?> <?= $cours[0]->getPrenom() ?? "" ?></a>
            <?php endif;?>
            <div class="flex items-center space-x-4">
                ...
                <a href="logout" class="flex items-center text-gray-300 hover:text-white transition duration-200">
...
<div class="flex">
    ...
    <div class="w-1/4 bg-white p-4">
        <ul>
            ...
            <li class="mb-2"><a href="ListeCours" class="text-gray-500">Cours</a></li>
            <li class="mb-2"><a href="Session" class="text-gray-500">Mes Sessions</a></li>
            <li class="mb-2"><a href="#" class="text-gray-500">Semestres</a></li>
    ...
    <div class="w-3/4 p-4">
       ...
       <form method="POST" action="listeCours" class="mb-4 flex space-x-4">
            <div>
